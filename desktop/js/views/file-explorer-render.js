...
function contextActionButton(action, label, className = 'file-explorer-context-action') {
  return `<button type="button" class="${className}" data-file-explorer-context-action="${action}" role="menuitem">${label}</button>`;
}
...
function contextMenuMarkup(state) {
  ...
  return `<div class="file-explorer-context-menu" style="${position}" role="menu" aria-label="Acciones del explorador">${hasTarget ? `${contextActionButton('context-open', 'Abrir')}${contextActionButton('context-copy', 'Copiar')}${contextActionButton('context-cut', 'Cortar')}${contextActionButton('context-copy-path', 'Copiar ruta')}${contextActionButton('context-reveal', 'Mostrar en el sistema')}${contextActionButton('context-rename', 'Renombrar')}${contextActionButton('context-delete', 'Eliminar', 'file-explorer-context-action file-explorer-context-danger')}` : ''}${contextActionButton('context-new-folder', 'Nueva carpeta')}${contextActionButton('context-new-file', 'Nuevo fichero')}${state.clipboard.paths.length ? contextActionButton('context-paste', 'Pegar') : ''}</div>`;
}
