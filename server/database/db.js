...
CREATE TABLE IF NOT EXISTS sdd_specs (
  ...
  title TEXT NOT NULL,
  description TEXT NOT NULL DEFAULT '',
  status TEXT NOT NULL DEFAULT 'draft' CHECK (status IN ('draft', 'active', 'approved', 'implemented')),
...
CREATE TABLE IF NOT EXISTS sdd_tables (
  id TEXT PRIMARY KEY,
  name TEXT NOT NULL,
  description TEXT NOT NULL DEFAULT '',
  created_at TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS sdd_columns (
  id TEXT PRIMARY KEY,
  table_id TEXT NOT NULL REFERENCES sdd_tables(id) ON DELETE CASCADE,
  name TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS sdd_media (
  id TEXT PRIMARY KEY,
  title TEXT NOT NULL,
  description TEXT NOT NULL DEFAULT '',
